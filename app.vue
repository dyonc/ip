...
<template>
  <div id="container">
    ...
    <Head>
      ...
      <Meta name="twitter:title" content="IP - Dyonic" />
      <Meta name="twitter:description" content="HTML, dynamically rendered in a city near you" />
      <Meta name="twitter:image" content="https://ip.dyonic.co/og-card.png" />
      <Meta name="twitter:image:alt" content="The Dyonic Logo" />
      <Meta name="og:image" content="https://ip.dyonic.co/og-card.png" />
    </Head>
    ...
    <footer>
      <p class="company">
        <a target="_blank" href="https://dyonic.co" aria-label="Dyonic">
          <LogoDyonic />
        </a>
      </p>
      <p class="details">
        by
        <NuxtLink to="https://dyonic.co" target="_blank">Dyonic</NuxtLink>
      </p>
      <NuxtLink target="_blank" href="https://github.com/dyonc/ip" class="source">
        <LogoGithub />
      </NuxtLink>
    </footer>
  </div>
